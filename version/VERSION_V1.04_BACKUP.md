...
cd /home/jopus/Blog
tar -xzf /home/jopus/Backup/Blog_V1.04_Backup_20251226.tar.gz
...
压缩包 `/home/jopus/Backup/Blog_V1.04_Backup_20251226.tar.gz` 包含以下内容：
- ✅ `source/` - 所有源文件（文章、页面等）
- ✅ `themes/` - 完整主题文件
- ✅ `scaffolds/` - 模板文件
- ✅ `_config.yml` - 主配置文件
...
- **Git标签**: `v1.04`（已创建）
- **压缩包备份**: `/home/jopus/Backup/Blog_V1.04_Backup_20251226.tar.gz`（已创建，158KB，包含114个文件/目录）
