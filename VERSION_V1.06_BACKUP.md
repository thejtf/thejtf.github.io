...
cd /home/jopus/Blog
tar -xzf /home/jopus/Blog_V1.06_Backup_20251226.tar.gz
...
压缩包 `/home/jopus/Blog_V1.06_Backup_20251226.tar.gz` 包含以下内容：
- ✅ `source/` - 所有源文件（文章、页面等）
...
- **Git标签**: `v1.06`（待创建）
- **压缩包备份**: `/home/jopus/Blog_V1.06_Backup_20251226.tar.gz`（已创建，2.5MB，包含376个文件/目录）
